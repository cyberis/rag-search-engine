...
def main() -> None:
    ...
    weighted_parser = subparsers.add_parser("weighted-search", help="Combine BM25 and semantic scores with a weighted average")
    weighted_parser.add_argument("query", type=str, help="Query string for the search")
    weighted_parser.add_argument("--alpha", type=float, default=0.5, help="Weight for BM25 score (default: 0.5)")
